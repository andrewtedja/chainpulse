...
// Dummy coin data (will be replaced with real backend data later)
...
export function BubbleChart() {
	...
	useEffect(() => {
		...
		// Use dummy coin data directly
		const processedData = dummyCoinData
	...
	}, []); // No dependencies needed since using static dummy data
